...
export default function MailButtonCopy({ showDialog, outputText, onToggleDialog }: Props) {
  ...
  return (
    <div className="relative">
      ...
      {showDialog && (
        <div className="tooltip-content visible bottom-12 left-1/2 -translate-x-1/2 opacity-100" role="popover">
          <div className="tooltip-body flex w-52 flex-col items-center justify-center gap-3 rounded-lg border-2 border-green-300 bg-green-100 p-4 text-start shadow transition duration-500 dark:border-green-500 dark:bg-green-800">
