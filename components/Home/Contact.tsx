      ...
      <div className={`mt-4 flex flex-col items-center justify-center gap-2 ${isBlock ? "w-full md:w-[25rem] lg:w-[35rem] xl:w-full" : "w-full"}`}>
        {[
          ...
          <div key={label} className="flex w-full flex-col items-start justify-center gap-1 md:flex-row md:items-center md:gap-4">
            ...
            <div className="input-group flex grow rounded-full bg-body transition duration-500 dark:border-neutral-400 dark:bg-neutral-600 dark:hover:border-neutral-400">
              <span className="input-group-text"><img className="size-5 select-none transition duration-500 dark:invert" src={icon} aria-hidden="true" /></span>
              <div className="input grow rounded-e-full">
                <p className="w-44 overflow-hidden overflow-ellipsis text-nowrap text-left transition duration-500 sm:w-full">{value}</p>
              </div>
              <Tooltip content="Copy" className="input-group-text p-0">
                <button className="btn btn-circle btn-text" type="button" onClick={() => copyText(value)}>
        ...
        {/* <div className="flex w-full flex-col items-start justify-center gap-1 md:flex-row md:items-center md:gap-4">
          ...
          <div className="input-group flex grow rounded-full bg-body transition duration-500 dark:border-neutral-400 dark:bg-neutral-600 dark:hover:border-neutral-400">
            <span className="input-group-text"><img className="size-5 select-none transition duration-500 dark:invert" src="/logo/discord.svg" aria-hidden="true" /></span>
            <div className="input grow rounded-e-full">
            ...
            <Tooltip content="Join" className="input-group-text p-0">
              <a className="btn btn-circle btn-text no-underline" href="https://discord.com/invite/9mJ9b2Bbzx" target="_blank" rel="noopener noreferrer">
