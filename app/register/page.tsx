        ...
        <form className="flex w-full flex-col items-center gap-4" onSubmit={onSubmit}>
          <label className="flex w-full flex-col gap-1">
            ...
            <input
              ...
              className="input rounded-lg border-neutral-300 bg-white px-3 py-2 text-black transition duration-500 dark:border-neutral-600 dark:bg-neutral-800 dark:text-white"
            />
          ...
          <button
            type="submit"
            disabled={loading}
            className="btn w-full rounded-lg border-blue-300 bg-blue-100 py-2 font-medium transition duration-500 hover:border-blue-400 hover:bg-blue-200 disabled:opacity-50 dark:border-blue-500 dark:bg-blue-800 dark:hover:bg-blue-700"
          >
